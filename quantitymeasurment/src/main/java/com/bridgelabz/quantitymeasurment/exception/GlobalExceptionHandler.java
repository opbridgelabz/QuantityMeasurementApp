package com.bridgelabz.quantitymeasurment.exception;

import com.bridgelabz.quantitymeasurment.QuantitymeasurmentApplication;
...
public class GlobalExceptionHandler {
    ...
    private final QuantitymeasurmentApplication application;

    GlobalExceptionHandler(QuantitymeasurmentApplication application) {
